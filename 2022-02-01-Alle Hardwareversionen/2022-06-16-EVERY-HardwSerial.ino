...
********* Always Queue - AiO oder Classic Version mit NANO oder NANO EVERY ************************
    ...
    - Über #define wird ausgewählt, ob die Software auf dem AiO - Board,
      ...
      oder Arduino Nano EVERY benutzt werden soll.
    ========================== AiO ========================================================================
...
#define LED_SR                 // LED Animation,Hardwareerweiterung erforderlich: (Neopixel LED's,Strip oder Ring)
 #ifndef EVERY                 // Bei TonUINO Classsic mit NANO, oder AiO, 
 #ifdef Konsole                // wird bei aktivierter Konsole define LED_SR inaktiv
 #undef LED_SR                 
 #endif                        
 #endif
...
//                           ___________________________________________________________________________________
  ...
  const float correction = 2.6 ;   // Korrekturwert für Spannungsteiler (Anpassung der Anzeige an die tatsächliche Batteriespannung)
  #endif
 #endif
// ------------------------------------------------------------------------------------------------------------------------------------
...
// ****************Anzeige Tasten und RFID Sperren ********************
void LockPause()
{
#ifdef Konsole
...
// ------------------------------------
  ...
  // } gemeinsame Schlussklammer für AiO , EVERY oder Classic weiter unten
...
#endif
#ifdef AiO
  Serial.print(F("** TONUINO - AiO **"));
#endif
  Serial.println();
  Serial.println();
  Serial.println(F("** VERSION THOMAS LEHNERT ** 2022-02-01 **"));
  Serial.println();
#ifndef AiO
...
/*
    ...
    ====================================================================================================
    - Codeanpassung an den Nano EVERY, Möglichkeit zur Steuerung des DF-Players über HardwareSerial (Serial-1).                     - Classic mit Nano-Every
